 ...
 */
/**
 星推官脚本 https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/jd_xtg.js
 ...
 // Loon
 [Script]
 cron "2 0 * * *" script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/jd_xtg.js,tag=京东星推官
 // Surge
 京东星推官 = type=cron,cronexp=2 0 * * *,wake-system=1,timeout=320,script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/jd_xtg.js
 */
const $ = new Env('京东星推官');
...
async function showMsg() {
  ...
  if (nowTime > new Date(activeEndTime).getTime()) {
    $.msg($.name, '活动已结束', `请删除或禁用此脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/orangeade98/jd_scripts_job`, {"open-url": "https://github.com/orangeade98/jd_scripts_job"});
    if ($.isNode()) await notify.sendNotify($.name + '活动已结束', `请删除此脚本\n如果帮助到您可以点下🌟STAR鼓励我一下,谢谢\n咱江湖再见\nhttps://github.com/orangeade98/jd_scripts_job`)
  } else {
