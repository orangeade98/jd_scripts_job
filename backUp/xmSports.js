...
Surge
[Script]
小米运动 = type=cron,cronexp="15 17 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js
小米运动获取Token = type=http-response,pattern=^https:\/\/account\.huami\.com\/v2\/client\/login, requires-body=1, max-size=0, script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js
圈X
[task_local]
# 小米运动
15 17 * * * https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js, tag=小米运动, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js
Loon
[Script]
cron "15 17 * * *" script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js, tag=小米运动
http-response ^https:\/\/account\.huami\.com\/v2\/client\/login script-path=https://raw.githubusercontent.com/orangeade98/jd_scripts_job/master/backUp/xmSports.js, requires-body=true, timeout=10, tag=小米运动获取Token
 */
